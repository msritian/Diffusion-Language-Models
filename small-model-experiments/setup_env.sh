...
pip3 install torch --index-url https://download.pytorch.org/whl/cu121 --no-cache-dir
pip3 install transformers accelerate datasets --no-cache-dir
pip3 install human-eval-infilling --no-cache-dir
